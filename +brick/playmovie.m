function playbutton = playmovie(M,varargin)
%PLAYMOVIE Simple showing of a movie
%---
% function playbutton = playmovie(M[,clip][,fps][,'once'][,'axisnormal'])
%---
% Simple display of movie.
% For color movie, time must be the 3rd dimension and color the 4th
% dimension.
% It is preferable to use brick.movie.
%
% See also brick.movie
...
pt = line('parent',ha,'xdata',1,'ydata',0,'marker','.','color','b','markersize',20, ...
    'buttondownfcn',@(u,e)brick.buttonmotion(@movepoint));
