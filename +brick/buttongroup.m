classdef buttongroup < hgsetget
    %BUTTONGROUP    Set of radio buttons or toggle buttons
    %---
    % function G = buttongroup(style,str,callback,'prop1',value1,...)
    %---
    % Input:
    ...
    methods
        function G = buttongroup(style,str,callback,varargin)
            % Input
            ...
            idx = find(brick.isemptyc(G.string));
