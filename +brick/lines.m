function out = lines(varargin)
%LINES Draw a series of vertical and/or horizontal lines
%---
% function hl = lines([xcoordinates,ycoordinates[,zcoordinates]][,ha][,'close'][,'bottom'][,'compact'][,line options])
% function hl = lines('x|y'[,xorycoordinates][,ha][,'bottom'][,'compact'][,line options])
%---
...
x = brick.float(x); y = brick.float(y); z = brick.float(z);
% (other options)
...
% Auto-coordinates
if ~carg
    [x y z] = brick.get(ha,'xtick','ytick','ztick');
end
