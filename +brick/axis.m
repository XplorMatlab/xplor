function axout = axis(varargin)
%AXIS Set axis range for a better visual aspect than 'axis tight'
%---
% function ax = axis([ha,]['tight|image|tightimage'][,sidefactor][,'y0|noy0'])
%---
