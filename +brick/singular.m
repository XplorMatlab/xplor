function sentence = singular(varargin)
% function [sentence =] singular([str0,]n1,str1,n2,str2,...)
%---
...
%
% exemple:
% >> brick.singular('We found ',3,' occurenceS, among which ',2,' WERE A perfect matchES.')
% We found 3 occurences, among which 2 were perfect matches.
% >> brick.singular('We found ',3,' occurenceS, among which ',1,' WERE A perfect matchES.')
% We found 3 occurences, among which 1 was a perfect match.
% >> brick.singular('We found ',1,' occurenceS, among which ',1,' WERE A perfect matchES.')
