function varargout = flags(varargin)
%FLAGS Detect flags in the arguments of a function
%---
% function [b1 ... bn] = flags({val1,...,valn},{arg1,...,argp})
% function [b1 ... bn] = flags({val1,...,valn},arg1,...,argp)
% function [b1 ... bn] = flags(val1,...,valn,{arg1,...,argp})
% function [b1 ... bn] = flags(val1,...,valn,arg)
% function x = flags(...)
%---
