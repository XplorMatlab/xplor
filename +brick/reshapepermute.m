function y = reshapepermute(x,varargin)
%RESHAPEPERMUTE Full capability for dimensions and shape manipulation
%---
% function y = reshapepermute(x,dimshift)
% function y = reshapepermute(x,resh,dimshift)
% function y = reshapepermute(x,resh,perm[,resh2])
%---
...
%               for example, brick.reshapepermute(x,{2 [1 3]}) is equivalent
...
if nargin==0, help brick.reshapepermute, end
