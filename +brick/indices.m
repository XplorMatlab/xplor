function varargout = indices(s,varargin)
%INDICES Convert between global and per-dimension indices
%---
% function globi = indices(sizes|array,i,j,k,...[,'i2g'])
% function globi = indices(sizes|array,ijk[,'i2g'])
% function [i j k...] = indices(sizes|array,globi[,'g2i'])
% function ijk = indices(sizes|array,globi[,'g2i'])
%---
...
% to zero.
%
% See also brick.imvect, brick.subsref

% Thomas Deneux
% Copyright 2004-2017

if nargin<2, help brick.indices, return, end
