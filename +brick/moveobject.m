function dp = moveobject(hobj,varargin)
% function [dp =] moveobject(hobj[,'latch'][,'point',i][,'pointer',pointer])
% function [dp =] moveobject(hobj,vector)
% function [dp =] moveobject(hobj,event)
%---
...
% set(hobj,'ButtonDownFcn',@brick.moveobject) to move hobj when selected.
% 
% Options
...
% 
% See also brick.buttonmotion, brick.pan
...
brick.buttonmotion({@movesub,hobj,ref,p0,pos0,pointidx,movedir},hf,'pointer',pointer)
if twiceflag
    brick.buttonmotion({@movesub,hobj,ref,p0,pos0,pointidx,movedir},hf,'pointer',pointer)
end
