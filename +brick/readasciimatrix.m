function a=readasciimatrix(filename,nheaders)
% function a=readasciimatrix(filename,nheaders)
% 
...
%
% See also brick.saveasciimatrix, brick.readdatlabview, brick.readtext, brick.readbin

% Thomas Deneux
% Copyright 2005-2017

if nargin==0, filename=brick.getfile; end
