function [hl cor pvalue] = regression(x,y,varargin)
%REGRESSION Perform linear regression and display data points and result
%---
% function [hl cor pvalue] = regression(x,y[,ha][,options...])
%---
...
if ~isempty(lineoptions), brick.set(hl(1),lineoptions{:}), end
if nargout==0, clear hl, end

% Axis
if dosquare
    brick.axis(ha,'image',1.2)
else
    brick.axis(ha,'tight',1.2)
end
