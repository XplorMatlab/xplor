function sliderenhance(hu,varargin)
%SLIDERENHANCE Allow a slider uicontrol to evaluate its callback during scrolling
%---
% function sliderenhance(sliderhandle)
%---
...
% just call 'brick.sliderenhance(sliderhandle)' once
%
% notes: 
