...
%COORDINATES Conversion of screen/figure/axes, normalized/pixel coordinates
%---
% function [orig scale] = coordinates([handle,]refchangetag)
% function x2 = coordinates([handle,]refchangetag,x1,'position')
% function v2 = coordinates([handle,]refchangetag,v1,'vector')
%---
...
% xy = brick.coordinates(1,'b2a',[10 10],'position')

% Thomas Deneux
% Copyright 2007-2017

if nargin<1, help brick.coordinates, return, end
...
if any(ismember('abc',refchangetag))
    ...
    posa = brick.pixelpos(ha,'recursive');
