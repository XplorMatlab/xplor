...
%SUBSREF Shortcut for calling Matlab subsref function
%---
% function B = subsref(A,idx1,idx2,...)
% function indices = subsref(siz,idx1,idx2,...[,'global|local'])
%---
% 
% Input:
...
%
% Examples:
% - brick.subsref([1 2 3; 4 5 6],':',2:3)   returns the sub-array [2 3; 5 6]
% - brick.subsref([1 2 3; 4 5 6],'1','1 3') returns the sub-array [1 3]
% - brick.subsref([2 3],'1','1 3','local')  returns the indices {[1] [1 3]}
% - brick.subsref([2 3],'1','1 3')          returns the indices [1 5]
%
% See also brick.indices, cellpop
