function saveimg(a,fname,varargin)
...
if nargin<1, help brick.saveimg, return, end
if nargin<2 || isempty(fname), fname=brick.savefile; end
...
if nt>1 && ~brick.ismemberstr(ext,{'gif' 'tif' 'tiff'})
...
for i=1:nt
    ...
    imwrite(fr,name,brick.switch_case(ext,'eps','psc2',ext))
end
