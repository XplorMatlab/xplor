...
if anonymouschar
    warning(['All variables saved to ' fname ' were anonymous character arrays. ' ...
        'Please be aware that function savevar''s syntax is different from function save, ' ...
