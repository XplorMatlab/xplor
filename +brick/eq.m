function b = eq(u,v,flag)
% function b = eq(u,v,'any|all')
%---
% test 'equality' between arrays of different sizes
% ex: 
%     b = brick.eq(1:10,randi(10,7,1)) determines which pairs of indices in
%                                   two vectors correspond to matching
%                                   values
%     b = brick.eq(jet,[1 0 0],'all')  determines which indices in colormap
%                                   'jet' correspond to color red
%
% See also brick.add, bsxfun
