function x = imageop(x,par)
%IMAGEOP Apply a series of transformations to an image
%---
% function a = imageop(a[,par])
% function par = imageop('par')
%---
...
if nargin==0, help brick.imageop, return, end
...
if ischar(x)
    ...
    par1 = defaultpar;
    if nargin>=2, par1 = brick.structmerge(par1,par,'skip'); end
    x = imageop(x,par1);
end
...
if par.xlow && par.xhigh
    a = brick.filt(a,[par.xlow par.xhigh],'bzm',[1 2]);
elseif par.xlow
    a = brick.filt(a,par.xlow,'lm',[1 2]);
elseif par.xhigh
    a = brick.filt(a,par.xhigh,'hzm',[1 2]);
end
