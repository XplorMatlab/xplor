function h = tensordisplay(varargin)
%TENSORDISPLAY Display of a field of 2x2 symmetric matrices using ellipses
%---
% function h = tensordisplay([X,Y,]Txx,Txy,Tyy[,'sigma',sigma][,'sub',sub][,color][,patch options...]])
% function h = tensordisplay([X,Y,]e[,'sigma',sigma][,'sub',sub][,color][,patch options...]])
