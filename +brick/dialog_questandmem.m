function answer = dialog_questandmem(question,identifier)
%DIALOG_QUESTANDMEM Confirmation question with an option for not asking again
%---
% function answer = dialog_questandmem(question[,identifier])
%---
...
%
% See also brick.reallydlg

% Thomas Deneux
% Copyright 2010-2017

if nargin==0, help brick.dialog_questandmem, return, end
...
if brick.ismemberstr(identifier,memkeep)
    answer = true;
    return
end
...
if ishandle(hf)
    ...
    mem = answer && brick.boolean(get(umem,'value'));
    close(hf)
else 
    mem = false;
    answer = false;
