function varargout = fftfrequencies(data,fs,flag)
%FFTFREQUENCIES Frequencies corresponding to the output of Matlab fft function
%---
% function ff = fftfrequencies(data,fs[,'centered'])
% function [ff1 ff2] = fftfrequencies(data,fs[,'centered[+shift]'])
%---
...
if nargin==0, help brick.fftfrequencies, return, end
