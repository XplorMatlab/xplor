function lineoptions = linespecs(varargin)
%LINESPECS Handle abbreviated plot options (e.g. 'r.')
%---
% function lineoptions = linespecs(line options as in plot)
% function lineoptions = linespecs({line options as in plot})
%---
...
% ex: opt=brick.linespecs('r:','linewidth',2);
%     line([0 1],[0 1],opt{:})
% 
%          b     blue          .     point              -     solid
