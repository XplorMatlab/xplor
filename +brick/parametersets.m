function x = parametersets(varargin)
% function x = parametersets(s)
% function x = parametersets('fieldname1',{values1a values1b...},'fieldname2',{values2a values2b ...},...)
