function setfigsize(hf,w,h)
%SETFIGSIZE Change the size of a figure, while keeping it within screen
%---
% function setfigsize(hf,w,h)
% function setfigsize(hf,'default')
% function setfigsize(hf)
%---
...
if nargin==0, help brick.setfigsize, return, end

% Multiple figures
if ~isscalar(hf)
    for k=1:numel(hf), brick.setfigsize(hf(k),w,h), end
    return
end
