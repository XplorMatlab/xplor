function d = xregister(a,b,maxshift)
%XREGISTER Fast fft-based coregistration at pixel (but not sub-pixel) resolution
%---
% function d = xregister(a,b,maxshift)
%---
...
if nargin==0, help brick.xregister, return, end
