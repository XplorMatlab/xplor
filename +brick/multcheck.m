classdef multcheck < hgsetget
    %MULTCHECK      Special control made of multiple check boxes
    %---
    % function multcheck([n,][properties])
    % function multcheck({'name1','name2',...},[properties])
    %---
