...
%SYM Convert a symmetric matrix to a vector and vice-versa
%---
% function s = sym(a[,uplo])
% function a = sym(s[,uplo])
% function idx = sym(ij[,uplo])
% function idx = sym(i,j[,uplo])
% function [i j] = sym(idx,[,uplo])
% function ij = sym(idx[,uplo])
...
if nargin==0, help brick.sym, return, end
