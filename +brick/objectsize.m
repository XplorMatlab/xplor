function [out1 out2] = objectsize(hobj,unit,varargin)
% function siz = pixelsize(hobj,unit[,'strict'])
% function [w h] = pixelsize(hobj,unit[,'strict'])
%---
% returns the width and height in pixels of any object without needing to
% change any units values
%
% See also brick.pixelsize

% Thomas Deneux
% Copyright 2019-2019 

% get size in pixels (possibly with the 'strict' flag for axes
siz_pix = brick.pixelsize(hobj, varargin{:});
