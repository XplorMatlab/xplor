function y = switch_case(varargin)
% function y = switch_case(x,y_true,[x2,y_true2,[...]]y_false)
% function y = switch_case(x,case1,y1,case2,y2,..,casen,yn[,ydefault])
% function y = switch_case(y,y_defaultifempty)
%---
...
%
% See also brick.cast, logical, onoff
...
if nargin<=2
    ...
    if nargin==1
        warning 'using brick.switch_case with only 1 argument is deprecated, use ''boolean'' or ''onoff'' function instead'
    ...
    elseif ischar(varargin{2}) && strcmp(varargin{2},'logical')
        warning 'using brick.switch_case with 2d argument ''logical'' is deprecated, use function ''boolean'' instead'
    ...
    elseif ischar(varargin{2}) && strcmp(varargin{2},'on/off')
        warning 'using brick.switch_case with 2d argument ''on/off'' is deprecated, use onoff function instead'
    ...
    elseif ischar(varargin{2}) && strcmp(varargin{2},'toggle')
        warning 'using brick.switch_case with 2d argument ''toggle'' is deprecated, use onoff function instead'
        % on/off switch
        switch x
            case 'on'
                y = 'off';
