function ha = subplot(varargin)
%SUBPLOT Subplots cover the figure without leaving any space
%---
% function ha = subplot([hf,]nrow,ncol,k[,spacing])
% function ha = subplot([hf,]ngraph,k) % hf must be an object figure handle here
% function ha = subplot(hnnk|hnk|nnk|nk)
%---
...
info = getappdata(hf,'brick_subplot');
...
setappdata(hf,'brick_subplot',info)
