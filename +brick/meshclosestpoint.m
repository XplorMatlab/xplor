function [i, p] = meshclosestpoint(P,p)
% function [i p] = meshclosestpoint(vert,p)
% function [i p] = meshclosestpoint(mesh)
%---
% Input:
...
if nargin<1, help brick.meshclosestpoint, return, end

% Select point in figure ?
fflag = nargin<2;
if fflag
    h = figure;
    brick.plotmesh(P), hold on
