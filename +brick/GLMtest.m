function [p beta out3] = GLMtest(X,y,h,testflag)
%GLMTEST Perform F-test and T-test in a GLM framework
%---
% function [p beta beta0] = GLMtest(X,y,h,'F')
% function [p beta betaproj] = GLMtest(X,y,h,'T')
%---
% 
% Input:
