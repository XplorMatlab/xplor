function output = geometry(operationName,varargin)
%GEOMETRY    geometry operations not implemented in matlab or implemented in
%               toolboxes
%---
% function output = geometry(operationName,varargin)
...
switch operationName
	...
	case "doSegmentsIntersect"
        ...
        boxA = brick.geometry('getBoundingBox',a);
        boxB = brick.geometry('getBoundingBox',b);
        
        output = brick.geometry('doBoundingBoxesIntersect',boxA,boxB) ...
            && brick.geometry('lineSegmentTouchesOrCrossesLine',a,b) ...
            && brick.geometry('lineSegmentTouchesOrCrossesLine',b,a) ...
        ;
    ...
    case "getIntersectionOfTwoSegments"
        ...
        % brick.geometry("doSegmentsIntersect",a,b) first.
        %
        % @param a: 2x2 double, with points in columns and x,y
        % coordinates in lines
        % @param b: 2x2 double
    ...
    case "lineSegmentTouchesOrCrossesLine"
        ...
        output = brick.geometry('isPointOnLine',a,b(:,1)) ...
            || brick.geometry('isPointOnLine',a,b(:,2)) ...
            || xor(brick.geometry('isPointRightOfLine',a,b(:,1)) ...
            ,brick.geometry('isPointRightOfLine',a,b(:,2))) ...
        ;
        %disp("lineSegmentTouchesOrCrossesLine: "+output)
    otherwise
        % case not found
        error("brick.geometry used with an unknowned operation: "+operationName)
end
