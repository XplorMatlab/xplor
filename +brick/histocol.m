function histocol(x,xrange,cidx,varargin)
%HISTOCOL Display an histogram of values with colors
%---
% function histocol(x,xbinwidth|xbinedges,cidx[,cmap][,'indiv'][,ha])
% function histocol(x,xbinwidth|xbinedges,pvalues[,'indiv'][,ha])
%---
...
if isscalar(xrange)
    ...
    xedges = xrange;
    x1 = sum(bsxfun(@ge,brick.column(x),brick.row(xedges)),2);
