classdef sensor < brick.uicontrol
    ...
    %                   clipping range
    %
    % See also brick.uicontrol, brick.clipcontrol
    ...
    methods
        ...
        function sense(S)
            ...
            switch S.mode
                case 'clip'
                    flag = brick.switch_case(get(S.hf,'selectiontype'), ...
                        'normal',   'minmax', ...
                        'extend',   'lumcon', ...
                        'alt',      'contrast', ...
                        'open',     'special');
            ...
            if strcmp(flag,'special')  
                ...
                brick.buttonmotion(@()move(S,val0,p0,flag),S.hf)
            end
            displayvalue(S)
        end
