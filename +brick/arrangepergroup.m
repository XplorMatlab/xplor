function [data1 npergroup] = arrangepergroup(data,conds,dim,varargin)
%ARRANGEPERGROUP    Re-arrange data according to specified grouping
%---
% function [data1 npergroup] = arrangepergroup(data,conds,dim[,'all'][,subconds])
%---
% 
% Input:
% - data        ND array 
...
else % TODO: code below seems not to handle all cases, and does not match code in brick.avgpergroup
    % input
...
nrep = brick.switch_case(flag,'same',min(npergroup),'all',max(npergroup));
