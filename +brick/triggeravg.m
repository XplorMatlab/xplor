function y = triggeravg(x,dim,indices,varargin)
%TRIGGERAVG Local average of data around specific indices in a given dimension
%---
% function y = triggeravg(x,dim,indices[,nframes][,'noavg'],['all'])
%---
